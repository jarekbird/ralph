...
// Copy templates from files that already live in this repo/package.
// This avoids maintaining duplicate copies of markdown prompt files under a separate templates/ folder.
const TEMPLATE_ROOT = PACKAGE_ROOT;
...
function handleInit(args) {
  ...
  for (const file of requiredFiles) {
    const srcPath = join(TEMPLATE_ROOT, file.src);
